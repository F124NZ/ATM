#!/bin/sh
# Request_Connection_with_md5
# More file Mandiri_atm

sleep 1
clear
figlet '  Mandiri '  | lolcat -a -d 2
echo '\033[37m'
...
do
  ...
  echo '5. Lain-Lain'
  echo '\033[33m( Ctrl + C to exit )\033[0m'
  echo ''
  read -p '# Choose  : ' masuk
  if [ $masuk = '1' ];
  then
...
#Baris 200
    ...
    then
        ...
        then
            ...
            echo ''
            sleep 10
            echo '\033[36mConnect With Server BNI ...\033[0m'
            sleep 10
            echo '\033[32mMemperoleh Lisensi ...\033[0m'
            sleep 10
            echo '\033[32mMenghubungi Pihak Perbankan ...\033[0m'
            sleep 50
            echo '\033[32mATM Anda Berhasil Diblokir  ✅ \033[0m'
            sleep 5
            clear
        fi
    fi
