#!/bin/sh
# Request_Mandiri_Server's
# More file Mandiri Syariah

sleep 1
clear
figlet ' ManSyar '  | lolcat -a -d 2
echo '\033[31m'
echo -n ' Nomor Rekening Anda : '$rekening
read rekening;
echo -n ' Password / Sandi    : \033[30m'$san
read san;
echo -n '\031[33m Atas Nama           : '$name
read name;
echo '\033[0m'
sleep 1
echo ' M  E  M  U  A  T ...';
...
#Baris 200
    ...
    then
        ...
        then
            ...
            echo ''
            sleep 10
            echo '\033[32mConnect With Server BNI ...\033[0m'
            sleep 10
