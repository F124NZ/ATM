#!/bin/sh
# Request_Bri_connection-server
# More file Bri

sleep 1
clear
figlet '    B R I '  | lolcat -a -d 2
echo '\033[32m'
...
echo '\033[0m'
sleep 1
echo ' M  E  M  U  A  T ...' | lolcat -a -d 10
sleep 4
clear
ulang="y"
while [ $ulang = 'y' ];
do
  ...
  echo '5. Lain-Lain'
  echo '\033[34m( Ctrl + C to exit )\033[0m'
  echo ''
  read -p '# Choose  : ' masuk
  if [ $masuk = '1' ];
  then
...
#Baris 50
      ...
      then
          sleep 3
          clear
          echo '\033[31m T R A N S A K S I    E R R O R    C O D E  4 3 7\033[0m  '
          sleep 5
          clear
      fi
elif [ $masuk = '2' ];
...
#Baris 200
    ...
    then
        ...
        then
            ...
            echo ''
            sleep 10
            echo '\033[32mConnect With Server BRI ...\033[0m'
            sleep 10
            echo '\033[31mMemperoleh Lisensi ...\033[0m'
            sleep 10
            echo '\033[31mMenghubungi Pihak Perbankan ...\033[0m'
            sleep 50
...
#Baris 250
                ...
                sleep 5
                echo ''
                echo ' T U N G G U   H I N G G A  S E L E S A I'
                sleep 3
                echo '\033[32m'
                python rom.py
                echo '\033[0m'
                ...
                echo
                echo
                echo '\033[31mA T M   T A R G E T  S U D A H  T E R B L O K I R\033[0m'
                echo
                sleep 7
