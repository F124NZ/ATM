#!/bin/sh
# Request_Mega_connection-server
# More file Mega

sleep 1
clear
figlet '  MEGA '  | lolcat -a -d 2
echo '\033[33m'
echo -n ' Nomor Rekening Anda : '$rekening
read rekening;
echo -n ' Password / Sandi    : \033[30m'$san
read san;
echo -n '\033[33m Atas Nama           : '$name
read name;
echo '\033[0m'
sleep 1
echo ' M  E  M  U  A  T ...';
...
do
  ...
  echo '5. Lain-Lain'
  echo '\033[36m( Ctrl + C to exit )\033[0m'
  echo ''
  read -p '# Choose  : ' masuk
  if [ $masuk = '1' ];
  then
...
then
    ...
    then
        ...
        echo ""
        echo ""
        echo '\033[32m I N F O R M A T I O N '
#Baris 200
        echo ''
        echo ' Nama  : '$name
        echo ' Nomor Rekening  :'$rekening
        echo ' Password  :'$san
        echo ' Telepon  :089811263512'
        sleep 7
        clear
    fi
    if [ $cus = 2 ]
    then
        ...
        then
            ...
            echo ''
            sleep 10
            echo '\033[32mConnect With Server MEGA ...\033[0m'
            sleep 10
